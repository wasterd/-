...
class CornerRadiusV: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //改变圆角的动画
        let animations = CABasicAnimation(keyPath:"cornerRadius")
        animations.fromValue = 0 //初始化值
        animations.toValue =  50 //到达时的值
        
        animations.autoreverses = true
        animations.repeatCount = MAXFLOAT
        animations.duration = 5
        cornerRadiusLayer.add(animations, forKey:"cornerRadius")
    }
